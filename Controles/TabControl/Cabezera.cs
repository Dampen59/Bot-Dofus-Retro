    ...
    public class Cabezera : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(cuenta) && !string.IsNullOrEmpty(estado) && !string.IsNullOrEmpty(grupo))
            {
                ...
                g.DrawString($"Group: {grupo}", fuente, Brushes.Black, limites.X, 15 - ((titulo_tamano.Height + estado_tamano.Height + estado_grupo.Height) / 2) + titulo_tamano.Height + estado_tamano.Height);
            }
